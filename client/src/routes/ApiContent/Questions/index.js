...
const QuestionsViews = ({match}) => (
  <Switch  history={history}>
    ...
    <Route path={`${match.url}/question-details/:id`} component={asyncComponent(() => import('./QuestionDetails'))}/>
    ...
    <Route path={`${match.url}/my-editor`} component={asyncComponent(() => import('./editor'))}/>
